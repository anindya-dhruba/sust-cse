...
@section('content')
	<div class="col-md-12">
		{{ Form::open(array('route' => array('admin.staff.edit', $staff->tagname), 'files' => true, 'method' => 'put')) }}
			<div class="row">
				<div class="col-md-4">
	        	...
	        	<a href="{{ URL::route('admin.staff.show', array('staff' => $staff->tagname)) }}" class='btn btn-success btn-block'>
					<span class="glyphicon glyphicon-zoom-in"></span> View this staff profile
				</a>
			</div>
					...
					<div class="row">
				    	...
				    	<div class="col-md-6">
					        ...
					        <div class="form-group">
					          	...
					          	{{ Form::select('status', User::$statusOptions, $staff->status, array('class' => 'form-control')) }}
					    ...
					    <div class="col-md-12">
					        ...
					        {{ Form::submit('Update Stuff', array('class' => 'btn btn-primary btn-lg', 'data-loading-text' => 'Updating...', 'type' => 'button')) }}
					    </div>
					</div>
			    </div>
			</div>
