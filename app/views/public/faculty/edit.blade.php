					...
					<div class="row">
					    ...
					    <div class="col-md-12">
					        ...
					        <div class="form-group">
					          	...
					          	{{ Form::textarea('publications', $faculty->publications, array('class' => 'form-control')) }}
					          	{{ Form::error($errors, 'publications') }}
					        </div>

					        <div class="form-group">
					          	{{ Form::label('journal_papers', 'Journal Papers') }}
					          	{{ Form::textarea('journal_papers', $faculty->journal_papers, array('class' => 'form-control')) }}
					          	{{ Form::error($errors, 'journal_papers') }}
					        </div>

					        <div class="form-group">
					          	{{ Form::label('conference_papers', 'Conference Papers') }}
					          	{{ Form::textarea('conference_papers', $faculty->conference_papers, array('class' => 'form-control')) }}
