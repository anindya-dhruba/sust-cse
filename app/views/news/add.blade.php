...
@section('content')
	<div class="col-md-12">
		...
		{{ Form::open(array('route' => 'admin.news.add')) }}
	        ...
	        <div class="form-group">
	          	...
	          	{{ Form::textarea('news', '', array('class' => 'form-control summernote')) }}
	        ...
	        <div class="form-group">
		        <div class="checkbox">
				    <label>
						{{ Form::checkbox('is_public', '1', true) }} This News is visible publicly
				    </label>
			  	</div>
			</div>
			{{ Form::submit('Add News', array('class' => 'btn btn-primary btn-lg', 'data-loading-text' => 'Adding...', 'type' => 'button')) }}
