	...
	<div class="col-md-12">
		...
		{{ Form::open(['route' => ['admin.courses.edit', $course->url], 'method' => 'put']) }}
	        ...
	        <div class="form-group">
				...
				{{ Form::select('course_taken_by', ['' => 'None']+['' => 'None']+User::select('id', DB::raw('CONCAT(first_name, " ", middle_name, " ", last_name) AS full_name'))->faculty()->lists('full_name', 'id'), $course->faculty_id, array('class' => 'form-control prerequisite')) }}
