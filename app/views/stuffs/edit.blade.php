...
@section('content')
	<div class="col-md-12">
		{{ Form::open(array('route' => array('admin.stuffs.edit', $stuff->tagname), 'files' => true, 'method' => 'put')) }}
			<div class="row">
				<div class="col-md-4">
	        	...
	        	<a href="{{ URL::route('admin.stuffs.show', array('stuff' => $stuff->tagname)) }}" class='btn btn-success btn-block'>
					<span class="glyphicon glyphicon-zoom-in"></span> View this stuff profile
				</a>
			</div>
				<div class="col-md-8 border-left">
					<h3>
						...
						<a href="{{ URL::route('admin.stuffs') }}" class='btn btn-primary pull-right'>
							<span class="glyphicon glyphicon-chevron-left"></span> View All Stuffs
						</a>
					</h3>
					<hr/>
					...
					<div class="row">
				    	...
				    	<div class="col-md-6">
					        ...
					        <div class="form-group">
					          	...
					          	{{ Form::select('status', User::$statusOptions, $stuff->status, array('class' => 'form-control')) }}
					    ...
					    <div class="col-md-12">
					        ...
					        {{ Form::submit('Update Stuff', array('class' => 'btn btn-primary', 'data-loading-text' => 'Updating...', 'type' => 'button')) }}
					    </div>
					</div>
			    </div>
			</div>
