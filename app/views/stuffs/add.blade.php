...
@section('content')
	<div class="col-md-12">
		{{ Form::open(array('route' => array('admin.stuffs.add'), 'files' => true)) }}
			<div class="row">
				<div class="col-md-4">
					<br/>
					<div class="alert alert-warning">
						...
						<ol>
							...
							<li>Click <b>add stuff</b> when you are done.</li>
						</ol>
					</div>
				</div>
				<div class="col-md-8 border-left">
					...
					<div class="row">
					    ...
					    <div class="col-md-12">
					        ...
					        {{ Form::submit('Add Stuff', array('class' => 'btn btn-primary', 'data-loading-text' => 'Adding...', 'type' => 'button')) }}
					    </div>
					</div>
			    </div>
			</div>
