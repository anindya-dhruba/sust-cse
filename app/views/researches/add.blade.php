...
@section('content')
	<div class="col-md-12">
		...
		<div class="row"> 
			{{ Form::open(array('route' => 'admin.researches.add')) }}
				<div class="col-md-4">
					<br/>
					<div class="alert alert-warning">
						...
						<ol>
							...
							<li>Click <b>add research topic</b> when you are done.</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-md-8">
			        ...
			        <div class="form-group">
			          	...
			          	{{ Form::textarea('description', '', array('class' => 'form-control summernote')) }}
			          	{{ Form::error($errors, 'description') }}
			        </div>
		        	
		        	{{ Form::submit('Add Research Topic', array('class' => 'btn btn-primary', 'data-loading-text' => 'Adding...', 'type' => 'button')) }}
		        </div>
